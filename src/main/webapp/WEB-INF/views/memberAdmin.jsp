...
<div class="py-4">
    <div style="width: 80%;  padding-right: 15px;  padding-left: 15px;  margin-right: auto;  margin-left: auto;">
        <div class="col-12">
            <h2 class="mt-2 font-weight-bold">회원 관리<br></h2>
            <div class="d-flex">
                <h6 class="mt-2">접속계정: ${l.getMem_id()} 권한:${l.getAuthority()}</h6>
                <button id="btnExcelDownload" class="btn btn-light ml-auto">엑셀 다운로드</button>
            </div>
        </div>
