...
<head>
    <title>계정생성</title>
    <!-- Slick Slider -->
    <link rel="stylesheet" type="text/css" href="<c:url value="/resources/vendor/slick/slick.min.css"/>"/>
    <link rel="stylesheet" type="text/css" href="<c:url value="/resources/vendor/slick/slick-theme.min.css"/>"/>
    <!-- Feather Icon-->
    <link href="<c:url value="/resources/vendor/icons/feather.css"/>" rel="stylesheet" type="text/css">
    <!-- BootStrap CSS -->
    ...
    <!-- JavaScript -->
    <script src="<c:url value="/resources/js/member_test.js"/>"></script>
</head>
<body>
...
<div class="py-4">
    <div class="row d-flex">
        <div class="col col-xl-3 col-lg-3 col-md-3 col-sm-3 col-12 mr-auto ml-auto">
            <div class="mt-5 row">
                <img class="ml-auto mr-auto" src="<c:url value="/resources/img/icon/topiaCI.png"/>" alt="" style="height: 80px; width: 240px"><br>
            </div>
            <h3 class="py-4 font-weight-bold" style="text-align: center">계정 생성_test</h3>
