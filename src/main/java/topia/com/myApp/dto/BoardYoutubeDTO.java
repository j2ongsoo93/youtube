...
public class BoardYoutubeDTO {
    ...
    public BoardYoutubeDTO() {
    }

    public BoardYoutubeDTO(Integer ytbIdx, String ytbTitle, String ytbUrl, String ytbInfo, Date ytbRegDate, Integer ytbHit, Integer ytbLike, String ytbChannelName, String ytbChannelUrl, String ytbThumbnail, String memId, String ytbChannelThumb, String ytbEmbedUrl, List<YtbReply> reList) {
        this.ytbIdx = ytbIdx;
